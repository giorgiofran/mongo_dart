  ...
  group('database', () {
    group('Database basic', () {
      ...
      group('Db creation tests:', () {
        ...
        test(
            'Error - operation not in Open state', testOperationNotInOpenState);
      });
      ...
      group('Indexes tests:', () {
        ...
        test('testEnsureIndexWithIndexCreation',
    ...
    group('Error handling:', () {
      print('Entered group Error handling');
      setUp(() async {
        await initializeDatabase();
      });
